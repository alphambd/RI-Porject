...
class InvertedIndex:
    ...
    def parse_boolean_query(self, query):
        ...
        while i < len(tokens):
            # Ignore les mots 'and', 'or', 'and not' (C'est pour dire qu'on les utilise comme des séparateurs pour combiner deux mots donc on ne doit pas les cherchés dans les mots)
