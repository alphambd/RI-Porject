...
class INEXRunGenerator:
    ...
    """
    def _create_element_cache(self, browse_index) -> Tuple[Dict, Dict]:
        
        #Crée un cache des éléments pour accès rapide.
        #Returns: (article_to_elements, element_details)
    ...
    def generate_fetch_browse_run_optimized(self,
                                          run_id: str,
                                          xml_dir: str,
