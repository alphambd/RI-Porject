...
def generate_field_weighted_run_cached(generator, run_id: str, run_type: str,
    ...
    filename = f"{team_name}_12_{run_id}_{run_type}_fields-{fields_str}_{config['stemmer']}_{config['stop_words']}_k{run_params.get('k1', 1.2)}_b{run_params.get('b', 0.75)}_CACHED.txt"
